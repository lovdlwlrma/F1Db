import { SeasonData, TeamStanding, DriverPositionStats } from '@/types/standings';
...
export class StandingsService {
  ...
  static calculateTeamStandings(seasonData: SeasonData): TeamStanding[] {
    ...
    seasonData.driver_standings.forEach(driver => {
      ...
      team.total_points += driver.cumulative_points[driver.cumulative_points.length - 1] || 0;
  ...
  static calculatePositionStats(seasonData: SeasonData): DriverPositionStats[] {
    return seasonData.driver_standings.map(driver => {
      // 過濾掉無效位置(-1, 0)
