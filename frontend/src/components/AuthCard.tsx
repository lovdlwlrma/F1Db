...
const AuthCard: React.FC = () => {
  return (
    <Card
      className="relative w-full max-w-md rounded-2xl bg-black/80 backdrop-blur-lg border border-red-500/30 shadow-2xl transition-transform hover:-translate-y-1 overflow-hidden"
    >
      ...
      <CardContent>
        <form className="space-y-6">
          ...
          <Button asChild className="w-full bg-gradient-to-r from-red-600 to-black text-white font-bold hover:brightness-125 shadow-lg transition-all">
            <a href="/">
              Start Racing
            </a>
          </Button>
